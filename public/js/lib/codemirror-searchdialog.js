        ...
        if (!_searchDialog) {
            ...
            $(cm.getWrapperElement()).append(
                    _searchDialog.html(closeIcon).append($("<div class='pull-left'>").append("<label>Search: <label>").append(searchInput),
                            [$("<div class='pull-left'>").append("<label>Back: <label>").append(backwardInput)
                             ,$("<div class='pull-left'>").append("<label>Replace: <label>").append(replaceInput)
                             , $("<div class='pull-left'>").append("<label>Regex: <label>").append(regexInput)
                             , $("<div class='pull-left'>").append(sButton, [rButton, rfButton, raButton]) ]));
        }
        setTimeout(function(){
